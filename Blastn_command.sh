...
tblastn -query $query_tblastn -subject $target -outfmt "6" -out tblastn_moj.txt -evalue 1e-3
...
blastn -query $query_l -subject $target -outfmt "6" -out balstn_dvir.txt -evalue 1e-3
tblastn -query $query_c -subject $target -outfmt "6" -out tbalstn_dvir.txt -evalue 1e-3
#-----------------------------------------------------------------------------------------------------------------------#
